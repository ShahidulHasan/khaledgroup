...
<div id="body">
    <div style="background:url(images/background1.gif) no-repeat left ;height: 297px;width: 100%;">
        <div id="bodyH" style="padding-top:0px;width:1px;height:100%;background:url(images/homepictwo.gif) no-repeat left;">
